...
from utils import get_candidates, format_candidates, get_candidate_by_id, get_candidate_by_skill
...
def skills(skill):
    ...
    return format_candidates(get_candidate_by_skill(candidates_list, skill))
